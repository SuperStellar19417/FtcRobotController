...
public class HardwareConstant {
    ...
    public static String LeftOdoPod = "leftFrontOdo"; // Expansion Hub Port 0 encoder slot
    public static String RightOdoPod = "rightFrontOdo"; // Control Hub Port 0 encoder slot
    public static String LateralOdoPod = "rightBackOdo"; // Control Hub Port 1 encoder slot
