...
public class SlidesSlightlyRetract implements Action {
    private IntakeSlide intakeSlide;
    private boolean initialized = false;
    private Telemetry telemetry;


    public SlidesSlightlyRetract(IntakeSlide intakeSlide, Telemetry telemetry){
    ...
    public boolean run(@NonNull TelemetryPacket telemetryPacket) {
        ...
        int goalPosition = intakeSlide.slidePosition;
