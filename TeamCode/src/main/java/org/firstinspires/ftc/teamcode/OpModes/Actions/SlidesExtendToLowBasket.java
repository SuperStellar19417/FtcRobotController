...
public class SlidesExtendToLowBasket implements Action {
    private IntakeSlide intakeSlide;
    private boolean initialized = false;
    private Telemetry telemetry;

    public SlidesExtendToLowBasket(IntakeSlide intakeSlide, Telemetry telemetry){
    ...
    public boolean run(@NonNull TelemetryPacket telemetryPacket) {
        ...
        if (pos < intakeSlide.SLIDE_POSITION_MAX - 100) {
            ...
            intakeSlide.slideMotor.setPower(intakeSlide.POWER_LEVEL_STOP);
            return false;
        }
